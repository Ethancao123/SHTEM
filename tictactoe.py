...
def isDraw():                                 #determines if the game is a draw
    for x in range(3):
        for y in range(3):
            if(game[x,y] == 0): 
...
                                             
def printTurn():                              #determines whose turn it is and returns true of a winner is found
    if(not hasWon()):
...
                             
def xGoes(x,y):                               #method that is called when X makes a move
...
                                             
def oGoes(x,y):                               #method that is called when O makes a move
    global isXTurn                            #same as the global variable isXTurn
    ...
    return True                               #returns true to represent a valid move
                                             
def isEmpty(x,y):                             #checks a certain location is empty
    return game[x,y] == 0
                                             
def hasWon():                                 #checks if a player has won the game
...
                                             
def printWon(player):                         #converts number to player letter and prints it with text
    print(translate[player] + " Wins!")       #uses the translate dictionary to translate the number value to a string value
                                             
def allEqual(list):                           #checks if a list of items is equal
    first = list[0]
    for elem in list:
        if elem != first:
...
                                             
def printGame(g):                             #formats the game and prints it into the terminal
    board = " {} | {} | {} \n------------ \n {} | {} | {} \n------------ \n {} | {} | {}"
...
                                             
sg.theme('DarkAmber')                         #creates the gamepad with pysimplegui
layout = [  [sg.Button('   '), sg.Button('   '), sg.Button('   ')],
            [sg.Button('   '), sg.Button('   '), sg.Button('   ')],
            [sg.Button('   '), sg.Button('   '), sg.Button('   ')] ]
window = sg.Window('Tic Tac Toe', layout)
                                             
while not isDraw() and not printTurn():       #loops until a player wins or the game becomes a draw
